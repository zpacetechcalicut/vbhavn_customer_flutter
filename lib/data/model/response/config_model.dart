class ConfigModel {
 ...
 // BaseUrls _baseUrls;
  ImageBaseUrls _imageBaseUrls;

  StaticUrls _staticUrls;
  List<CurrencyList> _currencyList;
  Language _language;

  ConfigModel({int systemDefaultCurrency, ImageBaseUrls baseUrls, StaticUrls staticUrls, List<CurrencyList> currencyList, Language language}) {
    this._systemDefaultCurrency = systemDefaultCurrency;
    this._imageBaseUrls = baseUrls;
  ...
  ImageBaseUrls get imageBaseUrls => _imageBaseUrls;
  ...
  //  _baseUrls = json['base_urls'] != null ? new ImageBaseUrls.fromJson(json['base_urls']) : null;
    _imageBaseUrls = json['base_urls'] != null ? new ImageBaseUrls.fromJson(json['base_urls']) : null;
  ...
  Map<String, dynamic> toJson() {
    ...
    if (this._imageBaseUrls != null) {
      data['base_urls'] = this._imageBaseUrls.toJson();
    }
...
class ImageBaseUrls {
  ...
  ImageBaseUrls({String productImageUrl, String productThumbnailUrl, String brandImageUrl, String customerImageUrl, String bannerImageUrl, String categoryImageUrl, String reviewImageUrl, String sellerImageUrl, String shopImageUrl, String notificationImageUrl}) {
    this._productImageUrl = productImageUrl;
  ...
  ImageBaseUrls.fromJson(Map<String, dynamic> json) {
    _productImageUrl = json['product_image_url'];
    _productThumbnailUrl = json['product_thumbnail_url'];
    _brandImageUrl = json['brand_image_url'];
    _customerImageUrl = json['customer_image_url'];
