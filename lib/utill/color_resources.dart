...
class ColorResources {
  ...
  static Color getPrimary(BuildContext context) {
    return Provider.of<ThemeProvider>(context).darkTheme ? Color(0xFFf0f0f0) : Color(0xffE2206B);
  }

  static const Color BLACK = Color(0xff000000);
  static const Color WHITE = Color(0xffFFFFFF);
  static const Color COLOR_PRIMARY = Color(0xFFd3264f);
  static const Color COLOR_BLUE = Color(0xffE2206B);
